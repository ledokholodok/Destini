...
struct StoryBrain {
    let stories = [
        Story( //0
            ...
            firstOption: "I'll hop in. Thanks for the help!", pathFirstOption : 2,
            secondOption: "Well, I don't have many options. Better ask him if he's a murderer.", pathSecondOption: 1
        ),
        Story( //1
            story: "He nods slowly, unphased by the question.",
            firstOption: "At least he's honest. I'll climb in.", pathFirstOption: 2,
            secondOption: "Wait, I know how to change a tire.", pathSecondOption: 3
        ),
        Story( //2
            ...
            firstOption: "I love Elton John! Hand him the cassette tape.", pathFirstOption: 5,
            secondOption: "It’s him or me. Take the knife and stab him.", pathSecondOption: 4
        ),
        Story( //3
            story: "What? Such a cop-out! Did you know accidental traffic accidents are the second leading cause of",
            firstOption: "The", pathFirstOption: 0,
            secondOption: "End", pathSecondOption: 0
        ),
        Story( //4
    ...
    mutating func nextStory(_ userOption : String){
        if userOption == stories[path].firstOption {
            path = stories[path].pathFirstOption!
        } else {
            path = stories[path].pathSecondOption!
        }
    }
    
    func getStory() -> String {
        return stories[path].story
    }
    
    func getFirstOption() -> String? {
        return stories[path].firstOption
    }
    
    func getSecindOption() -> String? {
        return stories[path].secondOption
    }
}
